...
1.对于求解大规模搜索空间的博弈问题极其有效

2.核心思想：把资源放在更值得搜索的分枝上，即算力集中在更有价值的地方

3.基本过程：

(1) 选择Selection：从根节点开始，根据Upper Confidence Bounds递归选择最优的子节点，最终到达一个叶子结点

(2) 扩展Expansion：如果当前叶子结点不是终止节点，那么就创建一个或者更多的子节点，选择其中一个进行扩展 

(3) 模拟Simulation： 从扩展节点开始，运行一个模拟的输出，直到博弈游戏结束。比如，从该扩展节点出发，模拟了十次，最终胜利九次，那么该扩展节点的得分就会比较高，反之则比较低

(4) 回溯Backpropagation：使用第三步模拟的结果，反响传播以更新当前动作序列

[[Link]](https://blog.csdn.net/weixin_41960890/article/details/125915825)
